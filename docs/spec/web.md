...
3. **Status channel and installation**: condition status, installation record, nonterminal-run query, 关于, the pre-upgrade backup command (11–13, 25–28). Blocked by `workflow` slice 1, `frontend` slice 3, `orchestration` slice 6.

...
Compiling settled every obligation but 29 items, `D-1`–`D-29`. Each is listed under **Open items** in the sub-specs it affects and blocks only the slices it names there. They are grouped into eight decision tickets on map #1:

| Items | Ticket |
|---|---|
| D-1–D-4 | [决策：预检发现的判定归属与 Source 投影](https://github.com/liumingjian/dbx/issues/92) |
| D-5–D-9 | [决策：调度器的输入与预估稳定性](https://github.com/liumingjian/dbx/issues/93) |
| D-10–D-13 | [决策：校验检查的定义与漂移记录](https://github.com/liumingjian/dbx/issues/94) |

...
const sampleRows = [
  {
    ...
    rowCount: '48,271,903',
    phase: messages.phase.writeComplete,
    conclusion: messages.conclusion.labels.SUPPORTED,
  },
  {
    sourceTable: 'orderitem_archive',
    targetTable: 'public.orderitem_archive',
    rowCount: '9,120,447',
    phase: messages.phase.readComplete,
    conclusion: messages.conclusion.labels.SUPPORTED,
  },
  {
    ...
    rowCount: '1,204,880',
    phase: messages.phase.stuck,
    conclusion: messages.conclusion.labels.INCONCLUSIVE,
  },
  {
    sourceTable: 'settlement_ledger_2024',
    targetTable: 'public.settlement_ledger_2024',
    rowCount: '312,005',
    phase: messages.phase.migrationComplete,
    conclusion: messages.conclusion.labels.SUPPORTED,
  },
  {
    ...
    rowCount: '84',
    phase: messages.phase.readComplete,
    conclusion: messages.conclusion.labels.UNSUPPORTED,
  },
] as const;
